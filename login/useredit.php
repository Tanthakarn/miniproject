...
<html lang="en">
    ...
    <div align="center">
            ...
            <form id="form_add" name="form_add" method="POST" action="edituser.php"  enctype="multipart/form-data">
                ...
                <div style="padding:5px"><button type = "button" id="bt_submit" name="bt_submit" Onclick="edit_user()"> บันทึก</div>
